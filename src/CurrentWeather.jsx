...
const CurrentWeather = ({temperature, feelsLike, sunsetTime, weatherDescription = 'des', Icon}) => {
  ...
  return (
    <div className='flex flex-col md:flex-row items-center shadow-md py-5 xl:px-6 mb-7 rounded-[30px] lg:flex-row md:justify-center xl:w-[780px] xl:h-[330px] '>
        {
            (
                <>
                    <div className='lg:mb-4 xl:w-[204px] xl:text-left'>
