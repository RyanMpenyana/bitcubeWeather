  ...
  return (
    ...
    <div className='flex flex-col items-center'>
        ...
        <div className='flex items-center lg:h-14 xl:h-[62px]'>
            <button className='flex items-center bg-light rounded-[40px] gap-1 h-full xl:text-[22px] text-white lg:font-extrabold lg:px-7 lg:py-4'><span><img src={currentLocationIcon} alt="currentLocationIcon" /></span><span className='hidden lg:block'>Current Location</span></button>
        </div>
    </div>
  )
}
